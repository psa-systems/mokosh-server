...
//!
//! parity record 2026-09-22: the SPA has no mileage entry surface today.
//! The routes stay mounted so `RequireTimeTracking` and the block-hours
//! consumption plumbing keep working; the entry screen is deferred.
