-- PMS-1300: recovery codes for platform-admin MFA.
--
...
-- migration 029's fourth column, so PMS-1293's login gate accepted a TOTP
-- code and nothing else - a lost authenticator was recovery-code-shaped
...
-- share through `utils::recovery::hash_code_hex` (PMS-1063).
--
...
COMMENT ON COLUMN platform_admins.mfa_recovery_codes_hashes IS
    'PMS-1300: sha256 hex hashes of the recovery codes the enable path minted. Spent by array_remove on match; plaintext is returned to the operator exactly once.';
