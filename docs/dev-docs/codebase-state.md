...
| Schema tables in the 2026-05-06 `001_initial_schema.sql` monolith, since split into [`migrations/`](../../migrations/) by PMS-128 | **71** |
| Tests | **0** |
| TODOs in source | **11** |
...
| Module | Schema tables in the 2026-05-06 `001_initial_schema.sql` monolith, since split into [`migrations/`](../../migrations/) by PMS-128 | Client UI surface affected |
| --- | --- | --- |
...
10. **Single 1688-line initial migration.** Adding any feature
    ...
    the `001_initial_schema.sql` monolith, since split into
    [`migrations/`](../../migrations/) by PMS-128,
...
12. **Cross-repo: client and server share DTOs by byte-identical
    ...
    `mokosh-clients/src/modules/...`, in that repository.
